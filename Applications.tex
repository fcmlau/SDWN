...
The nodes around cluster header (CH) send their data to the header, 
and each cluster header forwards it to another header until the root node receives the data. 

This kind of cluster method releases the energy hole problem~\cite{} of WSNs.
