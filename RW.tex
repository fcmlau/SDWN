...
However traditional distributed fashions for WSN can not promise global optimization. %without the support of SDN.
Worse, no existing work can combine them to run simultaneously.
To design a ecosystem for software defined sensor networks, 
we study five typical applications:
