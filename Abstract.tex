...
{\simpleLife}. By running diagnosis %and AI selection 
application, {\sdn} further increases the lifetime by {\diagLife} %and {\seleLife}
more. All source code and results of {\sdn} are ready to open source.
